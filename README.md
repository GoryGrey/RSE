...
Last Updated: January 01, 2026 (virtio-net TX backpressure + RX guardrails; empty net reads return EAGAIN; mergeable RX disabled pending reassembly; status refresh)
...
- virtio-net driver returns EAGAIN on TX queue full/empty reads and validates RX descriptors (mergeable RX disabled until reassembly support lands).
