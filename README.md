...
- /dev/net0 UDP loopback plus raw Ethernet/IP/TCP backend for AF_INET sockets when `RSE_NET_RAW=1` (retransmit/backoff, FIN retry, window backpressure, recv buffer backpressure, ARP cache aging).
