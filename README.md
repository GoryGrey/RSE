...
Last Updated: January 01, 2026 (virtio-net TX backpressure + RX guardrails; empty net reads return EAGAIN; net queue drop counter surfaced; mergeable RX disabled pending reassembly; status refresh)
